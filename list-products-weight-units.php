...
$more_css = '<style>#list_products_weight_units_php_table1_filter{display:none;}</style>
...
<div class="row">
	<div class="col">
		<div class="card">
			<div class="card-body">
<table class="row-border" id="list_products_weight_units_php_table1">
	...
	<tbody>
		...
		while($row = mysqli_fetch_array($result)) { 
			echo '<tr><td data-label="Description" id="tdid'.$row['id'].'"><span id="desc'.$row['id'].'">'.htmlspecialchars($row["description"]).'</span></td><td data-label="Action"> <span class="actionicon" ><i class="fa fa-edit" id="list_products_weight_units_php_table1_edit'.$row['id'].'"></i> </span> - <span class="actionicon" ><i class="fas fa-trash-alt" id="list_products_weight_units_php_table1_delete'.$row['id'].'"></i></span></td></tr>';  
		}
		?>
</tbody>
</table>
...
<!-- Modal -->
<div class="modal fade" id="modal_remove_product_weight_units" tabindex="-1" role="dialog" aria-labelledby="remove_product_title" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="remove_product_title">Remove Weight Unit</h5>
      ...
      <div class="modal-body">
        <div class="container-fluid">
			<div class="row mb-3">
				<div class="col">
					<h6>Are you sure you want to remove the selected unit?</h6>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-md-6 ml-auto">
					<button type="button" class="btn btn-primary btn-block" id="list_products_weight_units_php_yes_btn">Yes</button>
				</div>
			</div>		
		  </div>
      </div>
...
<!-- Modal -->
<div class="modal fade" id="modal_edit_product_weight_unit" tabindex="-1" role="dialog" aria-labelledby="edit_product_title" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="edit_product_title">Edit Weight Unit</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-md-6 ml-auto">
					<button type="button" class="btn btn-primary btn-block" id="list_products_weight_unit_php_save_btn">Save</button>
				</div>
			</div>		
		  </div>
      </div>
