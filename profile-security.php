...
<hr>
	<?php $uploadmessage='' ;if (isset($_GET['success' ])){if ($_GET['success' ] =='1' ){$uploadmessage='<div class="alert alert-success" role="alert">
							Password updated successfully
					</div>' ;}}if (isset($_GET['error' ])){if ($_GET['error' ] =='1' ){$uploadmessage='<div class="alert alert-danger" role="alert">Please check the current password.</div>' ;}if ($_GET['error' ] =='2' ){$uploadmessage='<div class="alert alert-danger" role="alert">New password don\' t match confirmed password</div>';
			}
			if ($_GET[' error'] == ' 3'){
