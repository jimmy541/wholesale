			...
			<div class="card w-50">
				<div class="card-body">
					...
					<form class="dataentry" action="php-scripts/process-edit-settings.php" method="post" autocomplete="off">
						...
						<input type="radio" name="anf1" value="5" id="anf5" class="form-radio" <?php if(getValue($link, $clientid, 'round_number_format' ) =='5' ){ echo 'checked' ;} ?>>
						<label class="form-radio-label" for="anf1">Round up to nearest whole number</label>
						<br>
						<input type="radio" name="anf1" value="1" id="anf1" class="form-radio" <?php if(getValue($link, $clientid, 'round_number_format' ) =='1' ){ echo 'checked' ;} ?>>
						<label class="form-radio-label" for="anf1">Nearest whole number</label>
						<br>
						<input type="radio" name="anf1" value="2" id="anf2" class="form-radio" <?php if(getValue($link, $clientid, 'round_number_format' ) =='2' ){ echo 'checked' ;}?>>
						<label class="form-radio-label" for="anf2">Nearest x.x9</label>
						<br>
						<input type="radio" name="anf1" value="3" id="anf3" class="form-radio" <?php if(getValue($link, $clientid, 'round_number_format' ) =='3' ){ echo 'checked' ;}?>>
						<label class="form-radio-label" for="anf3">Nearest x.99</label>
						<br>
						<input type="radio" name="anf1" value="4" id="anf4" class="form-radio" <?php if(getValue($link, $clientid, 'round_number_format' ) =='4' ){ echo 'checked' ;} ?>>
						<label class="form-radio-label" for="anf1">None</label>
						<br>
						<div class="group-fields">
							<button class="btn btn-primary" type="submit">Save</button>
						</div>
						<div class="group-fields">
							<?php if (isset($_GET['partID' ]) && $_GET['partID' ] =='1' ){ echo $responseMsg;} ?>
						</div>
					</form>
				</div>
			</div>
